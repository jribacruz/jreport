package br.jus.tre_pa.jreport.jreport.helper;
...
import br.jus.tre_pa.jreport.jreport.style.DefaultTextStyleClass;
import br.jus.tre_pa.jreport.jreport.table.DataTable;
import br.jus.tre_pa.jreport.jreport.table.DataTableBody;
import br.jus.tre_pa.jreport.jreport.table.Table;
...
public class DocumentHelper {
	...
	public static <T extends DataModelReport> DataTable<T> createDataTable(List<T> modelList, int numColumns, DataTableBody<T> dataTableBody) {
